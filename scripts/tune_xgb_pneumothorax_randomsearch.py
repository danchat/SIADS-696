...
RESULTS_CSV = OUT_DIR / "xgb_pneumothorax_randomsearch_cv_results.csv"

BEST_JSON = OUT_DIR / "xgb_pneumothorax_randomsearch_best.json"
...
def main():
    ...
    print(f"Task=pneumothorax rows={len(dft):,} prevalence={y.mean():.4f}")
